...
Characters statistics in Cogent Roleplay can be broken down into two categories which determine the bonuses (or penalties) you receive when rolling against **Challenge Levels **(**CL**) encountered in the game, whether **Actions** and **Conflicts**. These categorie\ses are:
...
| -----            | -----        | -----                 | ----- |
| **Strength**     | Average      | Soldier, Athlete      | Olympic Athlete |
| **Reflex**       | Average      | Acrobat, Thief        | Bruce Lee |
| **Intelligence** | Average      | Professor, Politician | Sherlock Holmes |
