\newcommand{\coverpage}[6]{
    ...
    %%%%%%%%%%%%%%%%%%%% Author Name %%%%%%%%%%%%%%%%%%%%
    \begin{pgfonlayer}{fg}
    \drawtext{\Large\textsc{#3}\\\Large\textsc{#4}\vspace{0.6em}\\\Large\textsc{#5}}{$(current page.east)+(-0.2,-5.1)$}{2cm}{0}{text=fg,anchor=east,align=right,font=\headingfontfamily};
    \end{pgfonlayer}

    %%%%%%%%%%%%%%%%%%%% Year %%%%%%%%%%%%%%%%%%%%
    \drawhexagon{\Large #6}{$(current page.west)+(2.5,-5)$}{2.5 cm}{0}{accent!60,draw,text=fg,font=\headingfontfamily};
